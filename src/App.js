...
import TradingBotPurchase from './pages/TradingBotPurchase';
import AdminBotRequests from './pages/AdminBotRequests';
        ...
        <Router>
          ...
          >
            <Routes>
              ...
              <Route path='/bot-purchase' element={<TradingBotPurchase route={route} />} />
              <Route path='/admin/bot-requests' element={<AdminBotRequests route={route} />} />
            </Routes>
          </motion.div>
        </Router>
      </AnimatePresence>
