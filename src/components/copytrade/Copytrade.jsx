        ...
        <div className='about-section copy-trade-section' id='about'>
            <div className="about-wrapper copy-trade-wrapper about-copy-trade-section">
                ...
                <div className="why-choose-us-text-container about-text copy-trade-text" data-aos="fade-up">
                    ...
                    <p >
                        Boardbank is an open-digital platform that maximizes the slightest differences in prices in the crypto digital market, co- partnerships with Artificial trading Intelligence agencies and real time investment in the real estate and natural resources sectors to in-turn create a satisfactory system for her clients. We also help to manage and save our client's funds for future use, ready to be withdrawn at a given point.
